...
public class ControlJoystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
            ...
            out position))
        {
            ...
            float y = (treshold.rectTransform.pivot.x == 1f) ? position.y * 2 + 1 : position.y * 2 - 1;
